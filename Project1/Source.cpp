...
int main()
{
	...
	while (window.isOpen())
	{
		...
		else if (green.getPosition().y > 700) {
			balls--;
			Score.setString("Your Score: " + to_string(score) + " Balls : " + to_string(balls));
			if (balls <= 0) {
		...
		else if (blue.getPosition().y > 700) {
			balls--;
			Score.setString("Your Score: " + to_string(score) + " Balls : " + to_string(balls));
			if (balls <= 0) {
				Score.setString("Game Over");
		...
		else if ((blue.getPosition().y >= 720 - 30 - blue.getGlobalBounds().height) && (blue.getPosition().x >= space.getPosition().x - blue.getGlobalBounds().width / 2 && blue.getPosition().x - 20 <= space.getPosition().x + space.getGlobalBounds().width - blue.getGlobalBounds().width + 20 /*&& green.getPosition().x >= space.getPosition().x - green.getGlobalBounds().width*/))
		{
			cout << "collision with space " << endl;
			sound.play();
			ybstep -= 6;
